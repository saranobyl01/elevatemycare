...
const TestimonialsSection = () => {
  return (
    <section className="py-16 md:py-20 bg-[#067d8e]">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg flex flex-col">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed flex-1">
                elevatemycare has been absolutely incredible! The setup was quick and easy,
              ...
              <div className="flex items-center space-x-3 mt-auto">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-1">
                    <span className="text-[#067d8e] text-sm">✓</span>
                    <span className="text-[#067d8e] text-sm font-medium">Verified Customer</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg flex flex-col">
              <h3 className="text-lg font-bold text-gray-900 mb-4">
                elevatemycare exceeded my expectations
              </h3>
              <p className="text-gray-700 mb-6 leading-relaxed flex-1">
                After years of failed diets and weight loss attempts, elevatemycare has been
