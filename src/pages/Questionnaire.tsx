    ...
    return (
      <div className="min-h-screen bg-white py-6 md:py-8 px-0 md:px-4">
        <div className="container mx-auto max-w-4xl px-0 md:px-4">
          ...
          {/* Terms Agreement */}
          <div className="bg-secondary/50 rounded-none md:rounded-xl p-4 md:p-6 lg:p-8 mb-6 md:mb-10 max-w-3xl mx-auto border-y md:border border-primary/30">
            <div className="flex items-start gap-3 md:gap-4 justify-center">
              ...
              >
                I Agree to elevatemycare's{" "}
                <a
                  href="https://www.elevatemycare.com/termsofservice/"
                  target="_blank"
                ...
                and consent to{" "}
                <a
                  href="https://www.elevatemycare.com/telehealthconsent/"
                  target="_blank"
                  className="text-primary font-semibold underline hover:no-underline"
                >
                  Telehealth
            ...
            <div className="flex justify-center px-4 md:px-2">
              <Button
                ...
                className="w-full max-w-2xl mt-4 px-6 sm:px-12 md:px-16 py-5 md:py-6 lg:py-7 text-base md:text-lg lg:text-xl font-bold"
              >
                Start my FREE visit →
              </Button>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-0 md:gap-4 mb-6 md:mb-10 max-w-4xl mx-auto">
            <div className="flex flex-col items-center text-center gap-3 p-4 md:p-5 bg-secondary/50 border-b-2 md:border-2 border-primary/30 rounded-none md:rounded-xl hover:shadow-xl transition-all duration-300 hover:border-primary/60">
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl border-2 border-primary/30 flex items-center justify-center bg-primary/20">
      ...
      <div className="min-h-screen bg-white py-6 md:py-12 px-0 md:px-4">
        <div className="container mx-auto max-w-4xl px-0 md:px-4">
          ...
          <div className="flex justify-center mb-6 md:mb-8">
            <img src={elevatemycareLogo} alt="elevatemycare" className="h-7 md:h-7" />
          </div>
          ...
          {/* Form */}
          <div className="bg-secondary/50 border-y-2 md:border-2 border-primary/30 rounded-none md:rounded-2xl p-4 md:p-10 lg:p-12 space-y-6 md:space-y-10 shadow-none md:shadow-lg">
            {/* State */}
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              >
                <div className="flex items-center space-x-3 p-3 md:p-4 border-2 rounded-xl hover:bg-secondary/50 hover:border-primary/30 transition-all cursor-pointer">
                  <RadioGroupItem
                    value="male"
                    id="male"
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="flex items-start gap-3 md:gap-4 p-3 md:p-4 bg-secondary/20 rounded-xl border border-primary/10">
                <Checkbox
                  id="emailConsent"
                ...
                >
                  ...
                  marketing messaging from elevatemycare to the email address that I
                  provided above.
                </label>
              </div>
            </div>
            ...
            <hr/>
            <div className="flex items-start gap-3 md:gap-4 p-3 md:p-4 bg-secondary/20 rounded-xl border-top border-primary/10">
                <Checkbox
                  id="smsTerms"
                  ...
                  className="mt-1 h-4 w-4 md:h-5 md:w-5 rounded-none"
                />
                <label
                  htmlFor="smsTerms"
                  className="text-xxs md:text-base leading-relaxed cursor-pointer"
                >
    ...
    return (
      <div className="min-h-screen bg-white py-6 md:py-12 px-0 md:px-4">
        <div className="container mx-auto max-w-4xl px-0 md:px-4">
          ...
          {/* Form */}
          <div className="bg-secondary/50 border-y-2 md:border-2 border-primary/30 rounded-none md:rounded-2xl p-5 md:p-10 lg:p-12 shadow-none md:shadow-lg">
              ...
              <div className="space-y-2 md:space-y-3">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="0"
                    className={`pr-16 md:pr-20 h-14 md:h-16 text-xl md:text-2xl font-medium border-2 focus:border-primary ${goalWeightError
                      ? "border-red-500"
                      : "border-primary/30"
                      }`}
                  />
      ...
      <div className="min-h-screen bg-white py-6 md:py-12 px-0 md:px-4">
        <div className="container mx-auto max-w-5xl px-0 md:px-4">
          ...
          <div className="text-center mb-6 md:mb-12 px-4 md:px-0">
            ...
            <p className="text-lg md:text-2xl lg:text-3xl xl:text-4xl font-bold text-primary">
              You are all set to lose {calculateWeightLoss()} Pounds!
            </p>
          </div>

          {/* Medical Weight Loss Plan */}
          <div className="bg-secondary/50 border-y-2 md:border-2 border-primary/30 rounded-none md:rounded-2xl p-4 md:p-10 lg:p-12 mb-6 md:mb-10 shadow-none md:shadow-lg">
            ...
            <div className="flex items-center justify-center mb-6 md:mb-12 px-2 md:px-0">
              <div className="flex items-center gap-2 md:gap-4 w-full justify-between max-w-lg">
                <div className="flex flex-col items-center flex-1">
                  <div className="w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full bg-primary/10 flex items-center justify-center border-3 border-primary">
                    <span className="text-primary font-bold text-center text-[10px] md:text-xs lg:text-sm leading-tight px-1">
                      Medication
                      <br />
                      Delivery
                    </span>
                ...
                <ArrowRight className="w-5 h-5 md:w-8 md:h-8 text-primary flex-shrink-0" />
                <div className="flex flex-col items-center flex-1">
                  <div className="w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full bg-primary/10 flex items-center justify-center border-3 border-primary">
                    <span className="text-primary font-bold text-center text-[10px] md:text-xs lg:text-sm leading-tight px-1">
                      Ongoing
                ...
                <ArrowRight className="w-5 h-5 md:w-8 md:h-8 text-primary flex-shrink-0" />
                <div className="flex flex-col items-center flex-1">
                  <div className="w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full bg-primary flex items-center justify-center border-3 border-primary">
                    <span className="text-primary-foreground font-bold text-center text-[10px] md:text-xs lg:text-sm leading-tight px-1">
                      Goal
                      <br />
                      Achieved!
                    </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
              <div className="bg-secondary rounded-xl md:rounded-2xl p-5 md:p-8 text-center border-2 border-primary/30 shadow-md">
              ...
              <div className="bg-primary/20 rounded-xl md:rounded-2xl p-5 md:p-8 text-center border-2 border-primary/40 shadow-md">
                <p className="text-sm md:text-base lg:text-lg text-black-300 mb-2 md:mb-3">
          ...
          <div className="bg-secondary/50 border-y-2 md:border-2 border-primary/30 rounded-none md:rounded-2xl p-5 md:p-10 lg:p-12 shadow-none md:shadow-lg">
            <div className="max-w-2xl mx-auto">
              <div className="space-y-4 md:space-y-6">
                ...
                >
                  <div className="flex items-center space-x-4 p-4 md:p-6 border-2 rounded-xl hover:bg-secondary/50 hover:border-primary/30 transition-all cursor-pointer">
                    <RadioGroupItem
                      value="yes"
                      id="current-med-yes"
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-10 px-4 md:px-0">
            ...
            <div
              ...
              className={`cursor-pointer p-6 md:p-8 rounded-xl border-2 transition-all duration-300 transform hover:scale-105 ${selectedMedicationType === "semaglutide"
                ...
                : "bg-secondary/50 border-primary/30 hover:border-primary/50 hover:bg-secondary/70"
                }`}
            >
    ...
    return (
      <div className="min-h-screen bg-white py-6 md:py-12 px-0 md:px-4">
        <div className="container mx-auto max-w-4xl px-0 md:px-4">
          ...
          {/* Form */}
          <div className="bg-secondary/50 border-y-2 md:border-2 border-primary/30 rounded-none md:rounded-2xl p-5 md:p-10 lg:p-12 mb-6 md:mb-10 shadow-none md:shadow-lg">
          ...
          {/* Benefits */}
          <div className="bg-secondary/50 border-2 border-primary/30 rounded-2xl p-10 md:p-12 mb-10 shadow-lg">
      ...
      <div className="min-h-screen bg-white py-6 md:py-12 px-0 md:px-4">
        <div className="container mx-auto max-w-4xl px-0 md:px-4">
          ...
          <div className="text-center mb-8 md:mb-12 px-4 md:px-0">
            ...
            {isLoadingProducts && (
              <p className="text-base md:text-lg text-primary animate-pulse mt-2">
                Loading products...
              </p>
            )}
          </div>
