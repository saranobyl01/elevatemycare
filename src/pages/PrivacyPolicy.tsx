  ...
  return (
    ...
    <div className="mx-auto pt-[80.8px] mb-8">
      ...
      <p className="mb-4 text-lg leading-relaxed">
        Med Excellence United LLC d/b/a elevatemycare (the “Company,” “we,” “our,” or “us”) respects your privacy, and we are
      ...
      <p className="mb-4 text-lg leading-relaxed">
        ...
        may provide when you visit the website  <a href="https://www.elevatemycare.com" className="text-blue-600 hover:underline underline">
      ...
      <p>
            Med Excellence United LLC d/b/a elevatemycare
        <br />
