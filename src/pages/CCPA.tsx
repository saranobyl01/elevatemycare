        ...
        <div className="mx-auto pt-[80.8px] mb-8">
            ...
            <div className="container px-3 sm:px-3 md:px-4 lg:px-8 mx-auto">
                <p className="mb-6 leading-relaxed text-lg">
                    ...
                    incorporated into, the Privacy Policy of Med Excellence United LLC and
                ...
                <ul className="list-disc pl-6 space-y-2 mb-4 leading-relaxed text-lg">
                    ...
                    {/* <li>Visiting our website at the and contacting us at link on <a href="https://www.elevatemycare.com/contact-us/" className="text-blue-600 hover:underline underline">elevatemycare.com/contact-us</a></li> */}
                </ul>
