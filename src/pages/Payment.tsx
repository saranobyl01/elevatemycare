...
import elevatemycareLogo from "@/assets/elevatemycare_logo.png";
...
const Payment = () => {
  ...
  // Check member price when email is pre-populated and valid
  useEffect(() => {
    if (
      medicationData?.email &&
      email.trim() &&
      validateEmail(email) &&
      selectedProductId &&
  ...
  const fetchSemaglutideProducts = async () => {
    ...
    try {
      const response = await axios.get(
        "https://panel.ravinimavat.com/wlmd_elevatemycare/api/get_all_sema"
      );
  ...
  const fetchTirzepatideProducts = async () => {
    ...
    try {
      const response = await axios.get(
        "https://panel.ravinimavat.com/wlmd_elevatemycare/api/get_all_tirz"
      );
      if (response.data.status === 1) {
        setMedicationProducts(response.data.data);
  ...
  const checkCouponCode = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://panel.ravinimavat.com/wlmd_elevatemycare/api/check_coupons",
        {
  ...
  const checkMemberPrice = async (userEmail: string) => {
    ...
    try {
      const response = await axios.post(
        "https://panel.ravinimavat.com/wlmd_elevatemycare/api/member_view",
        {
          email: userEmail,
      ...
      if (response.data.status === 1 && response.data.m_price) {
        ...
        console.log("Member Price:", response.data.m_price);
      } else {
        setMemberPrice(null);
      }
    } catch (error) {
  ...
  const submitOrder = async (planToSubmit?: string) => {
    ...
    try {
      ...
      // Call API
      const response = await axios.post(
        "https://panel.ravinimavat.com/wlmd_elevatemycare/api/createOrder_test",
        orderData,
        {
          headers: {
          ...
          [
            {
              ...
              item_name: product.product_name || "Product",
              price: finalPrice,
              quantity: 1,
            },
          ]
    ...
    <div className="min-h-screen bg-white py-4 md:py-6 px-0 md:px-3 lg:px-4">
      <div className="container mx-auto max-w-7xl px-0 md:px-4">
        ...
        <div className="flex justify-center mb-6 md:mb-12 px-4 md:px-0">
          <img src={elevatemycareLogo} alt="elevatemycare" className="h-8 md:h-8" />
        </div>

        <div className="grid lg:grid-cols-[1fr,1.1fr] gap-4 md:gap-6 items-start px-4 md:px-0">
          {/* Left Column - Payment Form */}
          <div className="order-2 lg:order-1 lg:border-r lg:border-primary/30 lg:pr-6">
            <Card className="p-4 md:p-6 shadow-lg border-2 md:border-2 border-y-2 border-x-0 md:border-x-2 border-primary/30 backdrop-blur-sm bg-secondary/50 rounded-none md:rounded-xl">
              {/* Header */}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.firstName ? "border-red-500" : ""
                            }`}
                        />
                        {errors.firstName && (
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.lastName ? "border-red-500" : ""
                            }`}
                        />
                        {errors.lastName && (
                          <p className="text-red-500 text-sm mt-1">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        maxLength={14}
                        className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.phone ? "border-red-500" : ""
                          }`}
                      />
                      {errors.phone && (
                        <p className="text-red-500 text-sm mt-1">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className={`h-14 text-lg pr-12 focus:ring-2 focus:ring-primary/20 ${errors.email
                            ? "border-red-500"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="h-14 text-lg focus:ring-2 focus:ring-primary/20"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Input
                          ...
                          maxLength={19}
                          className={`h-14 text-lg pl-12 focus:ring-2 focus:ring-primary/20 ${errors.cardNumber ? "border-red-500" : ""
                            }`}
                        />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          maxLength={5}
                          className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.expiry ? "border-red-500" : ""
                            }`}
                        />
                        {errors.expiry && (
                          <p className="text-red-500 text-sm mt-1">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          maxLength={4}
                          className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.cvc ? "border-red-500" : ""
                            }`}
                        />
                        {errors.cvc && (
                          <p className="text-red-500 text-sm mt-1">
                ...
                <div className="pt-2 space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.addressLine1 ? "border-red-500" : ""
                        }`}
                    />
                    {errors.addressLine1 && (
                      <p className="text-red-500 text-sm mt-1">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.city ? "border-red-500" : ""
                          }`}
                      />
                      {errors.city && (
                        <p className="text-red-500 text-sm mt-1">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      maxLength={5}
                      className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.zipCode ? "border-red-500" : ""
                        }`}
                    />
                    {errors.zipCode && (
                      <p className="text-red-500 text-sm mt-1">
                  ...
                  <div className="pt-2 space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.billingAddressLine1 ? "border-red-500" : ""
                          }`}
                      />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.billingCity ? "border-red-500" : ""
                            }`}
                        />
                        {errors.billingCity && (
                          <p className="text-red-500 text-sm mt-1">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        maxLength={5}
                        className={`h-14 text-lg focus:ring-2 focus:ring-primary/20 ${errors.billingZipCode ? "border-red-500" : ""
                          }`}
                      />
          ...
          <div className="order-1 lg:order-2 md:sticky md:top-0">
            ...
            <div className="space-y-3">
              ...
              <Card
                className={`p-4 md:p-5 rounded-xl cursor-pointer transition-colors duration-200 ${selectedPlan === "monthly"
                  ? "border-2 border-primary bg-primary text-primary-foreground shadow-xl ring-2 ring-primary/30"
                  : "border-[4px] border-border md:hover:border-primary/50 md:hover:shadow-lg bg-card"
                  }`}
                onClick={() => handlePlanSelection("monthly")}
              >
                <div className="text-center space-y-1.5 md:space-y-2">
                  <h3 className="text-base md:text-lg font-bold">
                    🩵 Monthly Plan — {medicationData?.medicationType === "tirzepatide" ? "$349.97/month" : "$299.00/month"}
                  </h3>
                  {loadingProducts ? (
                            ...
                            {memberPrice == product.price ? (
                              <>
                                {product.price !== 149.97 ||
                                  (product.price !== 249.97 && (
                                    <p className="text-xl md:text-2xl font-bold line-through opacity-60">
                                      ${product.price}
                                    </p>
                                  ))}
                              ...
                              <>
                                {/* <p className="text-xl md:text-2xl font-bold">
                                    $
                                    {!memberPrice ? product.price : memberPrice}
                                    <span className="text-sm opacity-90">
                                      {" "}
                                      / month
                                    </span>
              ...
              >
                <div className="text-center space-y-1.5 md:space-y-2">
                  <h3 className="text-base md:text-lg font-bold">
                    💎 3-Month Plan — {medicationData?.medicationType === "tirzepatide" ? "$333.00/month" : "$199.67/month"}
                  </h3>
                  {loadingProducts ? (
                    <p className="text-xl md:text-2xl font-bold">
                      Loading...
                        ...
                        return product ? (
                          <>
                            ...
                            >
                              ...
                              >
                                {medicationData?.medicationType === "tirzepatide" ? "$200 Total Savings" : "$300 Total Savings"}
                              </p>
                            </div>
                            <div className="mt-2 text-center space-y-1">
                              <div className={`text-xs space-y-0.5 ${selectedPlan === "3-month" ? "text-white" : "text-gray-600"}`}>
                                <p>📦 3-month supply shipped quarterly</p>
                                <p>💰 {medicationData?.medicationType === "tirzepatide" ? "Save $200 vs. monthly" : "Save $300 compared to monthly"}</p>
                          ...
                          <>
                            ...
                            >
                              ...
                              >
                                {medicationData?.medicationType === "tirzepatide" ? "$300 Total Savings" : "$200 Total Savings"}
                              </p>
                            </div>
                            <div className="mt-2 text-center space-y-1">
                              <div className={`text-xs space-y-0.5 ${selectedPlan === "3-month" ? "text-white" : "text-gray-600"}`}>
                                <p>📦 3-month supply shipped quarterly</p>
                                <p>💰 {medicationData?.medicationType === "tirzepatide" ? "Save $300 vs. monthly" : "Save $200 compared to monthly"}</p>
                                <p>⭐ {medicationData?.medicationType === "tirzepatide" ? "Most popular for new subscribers" : "Most popular for new members"}</p>
                              </div>
                            </div>
                          </>
              ...
              >
                <div className="text-center space-y-1.5 md:space-y-2">
                  <h3 className="text-base md:text-lg lg:text-xl font-bold">
                    ⚡ 6-Month Plan — {medicationData?.medicationType === "tirzepatide" ? "$299.83/month" : "$183.17/month"}
                  </h3>
                  {loadingProducts ? (
                        ...
                        return product ? (
                          <>
                            ...
                            >
                              ...
                              >
                                {medicationData?.medicationType === "tirzepatide" ? "$595 Total Savings" : "$695 Total Savings"}
                              </p>
                              <p
                            ...
                            <div className="mt-2 text-center space-y-1">
                              <div className={`text-xs space-y-0.5 ${selectedPlan === "6-month" ? "text-white" : "text-gray-600"}`}>
                                ...
                                <p>💰 {medicationData?.medicationType === "tirzepatide" ? "Save $595 vs. monthly" : "Save $695 compared to monthly"}</p>
                          ...
                          <>
                            ...
                            >
                              ...
                              >
                                {medicationData?.medicationType === "tirzepatide" ? "$750 Total Savings" : "$590 Total Savings"}
                              </p>
                              <p
                                className={`text-xs ${selectedPlan === "6-month"
                                  ? "text-gray-900"
                            ...
                            <div className="mt-2 text-center space-y-1">
                              <div className={`text-xs space-y-0.5 ${selectedPlan === "6-month" ? "text-white" : "text-gray-600"}`}>
                                <p>📦 Two 3-month shipments (90 days apart)</p>
                                <p>💰 {medicationData?.medicationType === "tirzepatide" ? "Save $750 vs. monthly" : "Save $590 compared to monthly"}</p>
                                <p>{medicationData?.medicationType === "tirzepatide" ? "✅ Great balance of savings & flexibility" : "🏆 Best value for consistent results"}</p>
                              </div>
                            </div>
                          </>
              ...
              {/* Coupon Code Section */}
              <Card className="p-4 md:p-5 bg-secondary/50 border border-primary/30 shadow-md">
              ...
              {/* Order Summary */}
              {selectedProductId && (
                <Card className="p-4 md:p-5 bg-gradient-to-br from-primary/5 to-primary/10 border-2 border-primary/40 shadow-lg">
              ...
              <Card className="p-4 md:p-5 bg-secondary/50 border border-primary/30 shadow-md">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 pt-1">
                    ...
                    {selectedPlan === "6-month" && (
                      <div className="flex items-center justify-between text-xs md:text-sm pt-1.5 border-t border-primary/20">
        ...
        <Dialog open={showSavingsModal} onOpenChange={setShowSavingsModal}>
          <DialogContent className="max-w-xl p-0 overflow-hidden border-2 border-primary/20">
            {/* Header with gradient */}
            <div className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground p-5 text-center relative overflow-hidden">
            ...
            {/* Savings Cards */}
            <div className="p-5 space-y-3 bg-gradient-to-b from-background to-secondary/30">
              {!modalSelectedPlan ? (
                <>
                  {/* 3 Month Plan */}
                  {(() => {
                    ...
                    return product ? (
                      <Card
                        className="p-4 border-2 border-primary/20 hover:border-primary/40 transition-all cursor-pointer hover:shadow-lg bg-white"
