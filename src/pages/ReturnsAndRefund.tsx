  ...
  return (
    ...
    <div className="container px-3 sm:px-3 md:px-4 lg:px-8 mx-auto">
      <p className="mb-6 leading-relaxed text-lg">
        At <span className="font-bold">elevatemycare</span>, we strive to provide the highest level of quality healthcare, 
      ...
      <p className="mb-6 leading-relaxed text-lg">
        ...
        <span className="font-bold">elevatemycare.com</span> account before your products ship to change your address,
      ...
      <p className="mb-6 leading-relaxed text-lg">
        elevatemycare may accept returns on unopened, non-prescription items up to 30 days after purchase. You will be
        ...
        >
          support@elevatemycare.com
        </a>. Include your order number, reason for return, and the product name. elevatemycare reserves the right to deny a
      ...
      <div className="mb-6 leading-relaxed text-lg">
        <p>Med Excellence United LLC / Manifest Pharmacy</p>
      ...
      <p className="leading-relaxed text-lg mb-8">
        In the rare case your package is lost in transit, elevatemycare will reship your prescription or non-prescription order.
